...
// ---------------------------------------------------------------------------
// Turn info extraction (B-7d partial)
// ---------------------------------------------------------------------------
...
fn extract_turn_info(gsm: Option<&serde_json::Value>) -> serde_json::Value {
...
fn extract_annotations(gsm: Option<&serde_json::Value>) -> Vec<serde_json::Value> {
